...
- Game state finite-state machine covering team proposals, voting, mission resolution, auto-fail handling, scoring, and mission action/public summary logging (`avalon.game_state`).
